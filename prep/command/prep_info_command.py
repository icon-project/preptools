...
from ..prep.prep import create_reader_by_args
...
def _check_get_preps_args(args):
    ...
    if hasattr(args, 'startRanking'):
        params['startRanking'] = args.startRanking

    if hasattr(args, 'endRanking'):
        params['endRanking'] = args.endRanking

    if hasattr(args, 'blockHeight'):
        params['blockHeight'] = args.blockHeight
